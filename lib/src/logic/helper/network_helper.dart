...
class NetworkHelper {
  ...
  Future<dynamic> changePassword(
      String confirmPassword, String newPassword, String currentPassword, String token) async {
    var body = {
      "currentPassword": currentPassword,
      "newPassword": newPassword,
      "confirmNewPassword": confirmPassword
    };
    return await postRequest(url: 'api/auth/change-admin-password', body: body, token: token);
  }
  ...
  Future<dynamic> searchFriends(String? token, String? name) async {
    ...
    return await getParamRequest(url: 'api/auth/search-friends', params: params, token: token!);
  }
  ...
  Future<dynamic> getPaymentOptions(String? token) async {
    return await getRequest(url: 'api/purcahse/get-all-payment-options', token: token);
  }

  ///Checkout
  Future<dynamic> checkOut(String token, List<Map<String, dynamic>> cartList, String paymentId) async {
    ...
    return await postRequest(url: 'api/purcahse/check-out',body: body, token: token);
  }
